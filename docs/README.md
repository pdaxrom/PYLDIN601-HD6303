...
Адрес|Устройство
----|----
10-1F|VPU - Видеоконтроллер
A0-AF|SimpleIO - Периферия SimpleIO
B0-B1|PSG - Звуковой генератор
C0-C4|SPI - Последовательный периферийный интерфейс
D0-D1|PS/2 - порт клавиатуры
FE-FF|IRQ Router - Маршрутизация IRQ
...
16 битный регистр назначение прерываний, адрес E6FE.
